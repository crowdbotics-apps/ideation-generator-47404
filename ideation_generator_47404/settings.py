"""
Django settings for ideation_generator_47404 project.
...
ROOT_URLCONF = 'ideation_generator_47404.urls'
...
WSGI_APPLICATION = 'ideation_generator_47404.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ideation_generator_47404 API",
    "DESCRIPTION": "API documentation for ideation_generator_47404 App",
    "VERSION": "v1",
}
